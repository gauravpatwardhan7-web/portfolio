...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--background)", color: "var(--foreground)" }}>
      {/* Header */}
      <header className="sticky top-0 z-50 border-b w-full" style={{ background: "var(--background)", borderColor: "var(--border)" }}>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-12 md:gap-16">
              ...
              <div className="space-y-8">
                ...
                {/* Stats */}
                <div className="reveal grid grid-cols-2 md:grid-cols-4 md:w-fit gap-px" ref={addRevealRef} style={{ background: "var(--border)" }}>
